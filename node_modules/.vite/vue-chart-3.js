...
var import_pascalcase = __toESM(require_pascalcase(), 1);
var import_pascalcase2 = __toESM(require_pascalcase(), 1);
...
var defineChartComponent = (chartName, chartType) => {
  ...
  const componentName = (0, import_pascalcase.default)(chartName);
  return defineComponent({
    ...
    setup(props, { emit, expose }) {
      ...
      watch(() => props.options, (newOptions, oldOptions) => {
        if (chartInstance.value && newOptions && !isEqual_default(chartInstance.value.options, oldOptions)) {
          chartInstance.value.options = cloneDeep_default(newOptions);
          oldOptions = cloneDeep_default(newOptions);
          handleChartUpdate();
        }
      }, { deep: true });
      function watchHandler(newData, oldData) {
        if (oldData && chartInstance.value) {
          ...
          if (!isEqual_default(newData, oldData) && oldData.datasets.length === newData.datasets.length) {
  ...
  return (params) => {
    ...
    function update2() {
      ...
      if (chartComponentRef) {
        ...
        console.warn(`No chartInstance to update (use${(0, import_pascalcase2.default)(chartType)}Chart)`);
      }
    }
    return {
